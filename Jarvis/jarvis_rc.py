...
class Jarvis:
    ...
    def __init__(self, WORKSPACE_URL, WORKSPACE_AUTH, POST_AUTH, debug_mode=False, display_mode=False):
        ...
        # Jarvis brain
        self.BRAIN = pickle.load(open("Classifiers/jarvis_mlp_REDPIRANHA_recoverycoach", 'rb'))
    ...
    def recovery_chat(self, message, channel):
        result = self.BRAIN.predict([message])
...
class Database:
    ...
    def open_connection(self):
        ...
        self.conn = sqlite3.connect('jarvis_rc.db', check_same_thread=False)
